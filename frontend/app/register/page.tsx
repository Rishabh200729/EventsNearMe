      ...
      <div className="glass-card w-full max-w-lg space-y-8 animate-float">
        ...
        <form action={handler} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              <option value="user" className="bg-background">Participator</option>
              <option value="organizer" className="bg-background">Creator</option>
            </select>
          </div>
          ...
          <SubmitButton type="submit" loadingText="Creating..." className="premium-button w-full py-4 text-lg font-semibold">
            Create Account
          </SubmitButton>
        </form>
